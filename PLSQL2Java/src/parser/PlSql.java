...
/* Represents a PLSQL code block. */
  ...
  final public void AlterSession() throws ParseException {
...
void BeginEndBlock() throws ParseException {
  ...
  final public void ProcedureReference() throws ParseException {String name;
...
{if ("" != null) return name.toString();}
  ...
  final public void TableName() throws ParseException {String s;
...
/* Checks for whatever follows  SELECT */
  ...
  final public void FunctionReference() throws ParseException {String name;
    name = ObjectReference();
